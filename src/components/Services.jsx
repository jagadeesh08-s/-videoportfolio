...
const TagCard = ({ number, title, text, techStack, link, linkText, className, aosDelay, aosType, pathLength, containerRef }) => {
  ...
  return (
    <div 
      ...
      className={`w-full max-w-[320px] sm:max-w-none sm:w-80 rounded-[2rem] p-2 relative flex flex-col items-center hover:scale-[1.02] transition-all duration-700 z-10 ${className} ${
